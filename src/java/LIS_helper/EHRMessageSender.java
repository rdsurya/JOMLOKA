...
public class EHRMessageSender {
    ...
    public String getMSH(String senderApp, String receiverApp) {
        ...
        // Setting MSH Variable
        String seperatorMSH = "MSH";                                    // Data 1
        String encodeCharacMSH = "^~";                                  // Data 2
        String sendAppliMSH = senderApp;//"06";                        `// Data 3 change here for sender: 05-LIS
    ...
    public String getORC(String txn_code, String senderApp, String receiverApp) {
        ...
        String orderApplicationORC = senderApp; //"06";                         // Data 15 I change here from 04-PIS to 05-LIS sender app
...
//==================================================== end getORC ==============================================================================
    ...
    public void insertIntoEHR_FAR(String senderApp) {
        ...
        String sqlUpdateBillingStatus = "Update lis_order_master set billing_status = '2' Where order_no = '" + orderNo + "';";

        rmic.setQuerySQL(conn.HOST, conn.PORT, sqlUpdateBillingStatus);

    }

    public void updateLOMBillingStatus() {

        RMIConnector rmic = new RMIConnector();

        String sqlUpdateBillingStatus = "Update lis_order_master set billing_status = '0' Where order_no = '" + orderNo + "';";
