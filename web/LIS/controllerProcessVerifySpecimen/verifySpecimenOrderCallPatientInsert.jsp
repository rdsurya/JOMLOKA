<%-- 
    Document   : verifySpecimenOrderCallPatientInsert
    Created on : May 10, 2018, 11:14:34 PM
    Author     : Shammugam
--%>
...
<%
    ...
    for (int i = 0; i < sizeGetRoomNo; i++) {
        cs_room_no = dataGetRoomNo.get(i).get(0).toString();
    }
