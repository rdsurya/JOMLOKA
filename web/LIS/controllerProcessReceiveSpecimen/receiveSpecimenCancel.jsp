<%-- 
    Document   : receiveSpecimenCancel
    Created on : Jan 15, 2018, 11:48:21 PM
    Author     : Shammugam
--%>
<%-- 
    Document   : receiveSpecimenReject
    Created on : Jan 15, 2018, 8:05:34 PM
    Author     : Shammugam
--%>
...
<%
    ...
    for (int i = 0; i < stockDetailD.length; i++) {
        ...
        String sqlInsertSpecimenDetail = "UPDATE lis_specimen_detail "
                + " SET specimen_status = 'Cancelled' , approval = 'Cancel Approval' "
        ...
        String sqlUpdateOrderDetail = "UPDATE lis_order_detail "
                + " SET Verification = 'Cancelled' , detail_status='2'  "
