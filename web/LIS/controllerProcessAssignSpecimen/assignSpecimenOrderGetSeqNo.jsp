<%-- 
    Document   : assignSpecimenOrderGetSeqNo
    Created on : Jan 15, 2018, 3:20:20 PM
    Author     : Shammugam
--%>
...
<%
    ...
    if (dataSeqSelect.isEmpty()) {
        ...
        String sqlSeqCreate = " INSERT INTO lis_last_seq_no (hfc_cd, module_name, year_seq, status, created_by, created_date) "
                + " VALUES ('" + hfc + "','SPE','" + dateString + "','0','" + created_by + "','" + created_date + "' ) ";
