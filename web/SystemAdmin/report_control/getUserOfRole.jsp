<%-- 
    Document   : getUserOfRole
    Created on : Aug 14, 2017, 4:15:09 PM
...
<tbody>
    ...
    <%
        ...
        String sql = "select  ar.`USER_ID`, u.`USER_NAME`, d.discipline_name, s.subdiscipline_name "
                ...
                + "where ar.`HEALTH_FACILITY_CODE`='"+hfc+"' and ar.role_code='"+role_code+"';";
            ...
            buttons: [
                {
                    ...
                    title: 'Administration: List of <%=role_name%>',
                    ...
                    customize: function (win) {
                        $(win.document.body)
                                ...
                                .prepend(
                                        ...
                                        <img src="<%=mysqlhfc_cd.get(0).get(0)%>" style="text-align: center; height: 100%; " /></div> <div class="mesej"><br>Administration: List of <%=role_name%></div>\n\
                       ...
                       $(win.document.body).find('table')
                        ...
                        $(win.document.body)
                                ...
                                .append('<div style="text-align: right;padding-top:10px;"><br>Total Number of <%=role_name%> : <%=dataATC.size()%> </div>');
                        $(win.document.body)
                                .css('font-size', '10pt')
