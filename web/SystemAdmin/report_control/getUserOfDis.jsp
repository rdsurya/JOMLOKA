<%-- 
    Document   : getUserOfDis
    Created on : Aug 14, 2017, 6:35:46 PM
...
%>
<h4 style="padding-top: 2%;padding-bottom: 1%;">List Of User of <%=dis_name%> </h4>
<br>
...
<tbody>
    ...
    <%
        ...
        String sql = "select  ar.`USER_ID`, u.`USER_NAME`, d.discipline_name, s.subdiscipline_name "
                ...
                + "where ar.`HEALTH_FACILITY_CODE`='"+hfc+"' and ar.discipline_code='"+dis_cd+"' ;";
            ...
            buttons: [
                {
                    ...
                    title: 'List Of User of <%=dis_name%>',
                    ...
                    customize: function (win) {
                        $(win.document.body)
                                ...
                                .prepend(
                                        ...
                                        <img src="<%=mysqlhfc_cd.get(0).get(0)%>" style="text-align: center; height: 100%; " /></div> <div class="mesej"><br>Administration: List Of User of <%=dis_name%></div>\n\
                                        <div class="info_kecik">\n\
                                        <dd>Date: <strong><%=newdate%></strong></dd>\n\
                                        <dd>Report No: <strong>ADM-0007</strong></dd>\n\
                                        </div> '
                                        );
                       $(win.document.body).find('table')
                        ...
                        $(win.document.body)
                                ...
                                .append('<div style="text-align: right;padding-top:10px;"><br>Total Number of User of <%=dis_name%> : <%=dataATC.size()%> </div>');
                        $(win.document.body)
                                .css('font-size', '10pt')
