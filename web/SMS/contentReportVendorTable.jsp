<%-- 
    Document   : contentReportVendorTable
    Created on : Dec 12, 2017, 7:03:42 PM
    Author     : Shammugam
--%>
                    ...
                    customize: function (win) {
                        $(win.document.body)
                                ...
                                .prepend(
                                        ...
                                        <img src="<%=mysqlhfc_cd.get(0).get(0)%>" style="text-align: center; height: 100%; " /></div> <div class="mesej"><br>Vendor List</div>\n\
                                        <div class="info_kecik">\n\
                                        <dd>Date: <strong><%=newdate%></strong></dd>\n\
                                        <dd>Report No: <strong>SMS-0003</strong></dd>\n\
                                        </div> '
                                        );
