<%-- 
    Document   : HIS220007
    Created on : Dec 12, 2017, 5:59:36 PM
    Author     : Shammugam
--%>
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div  class="thumbnail">
                                ...
                                <h3>List of Stock Items</h3>
                                <hr class="pemisah"/>

                                <div id="contentReportItemTable" class="table-guling">
                                </div>
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $("#contentReportItemTable").load("contentReportItemTable.jsp");
