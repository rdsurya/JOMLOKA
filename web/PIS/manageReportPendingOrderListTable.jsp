<%-- 
    Document   : manageReportPendingOrderListTable
    Created on : May 29, 2017, 1:59:45 PM
    Author     : Shammugam
--%>
...
%>
<h4 style="padding-top: 2%;padding-bottom: 1%;">List Of Pending Order</h4>

<table  id="reportListPenddingOrderTable"  class="table table-filter table-striped table-bordered" style="background: #fff; border: 1px solid #ccc; width: 100%">
    <thead>
    <th style="text-align: left;">Order No.</th>
    <th style="text-align: left;">PMI No.</th>
    <th style="text-align: left;">Name</th>
    <th style="text-align: left;">Order Date</th>
    <th style="text-align: left;">Total Pending Order</th>
...
<script type="text/javascript" charset="utf-8">
    $(document).ready(function () {
        $('#reportListPenddingOrderTable').DataTable({
            ...
            buttons: [
                {
                    ...
                    title: 'Pharmacy Pending Order List',
