...
//});
     ...
     $(function () {
                $("#ajax1").on('keyup', function () { // everytime keyup event
                    ...
                    if (input.length >= 1) { // Minimum characters = 2 (you can change)
                        ...
                        $.ajax({
                            type: "POST",
                            url: "search/resultDGS_5.jsp", // call the php file ajax/tuto-autocomplete.php
                            data: dataFields, // Send dataFields var
                            timeout: 3000,
                            success: function (dataBack) { // If success

                                console.log(dataBack)
                              // $('#divDiag').html(dataBack); // Return data (UL list) and insert it in the <div id="match"></div>
