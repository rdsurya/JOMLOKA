...
<%
   ...
   String whereCondition="", tabStat="";
    ...
    String query="SELECT date_format(encounter_date, '"+timeFrame+"') as masa, order_status, count(order_no) "
...
<script>
    ...
    <img src="<%=logo.get(0).get(0)%>" style="text-align: center; height: 100%; " /></div> <div class="mesej">Operatin Theater Order Status</div>\n\
