<%-- 
    Document   : fullreportComplaint
    Created on : Feb 19, 2017, 12:51:21 PM
    Author     : User
--%>
    ...
    <body>
        ...
        <div class='container'>
            <div class='row'>
                ...
                <div id="fullReportComplaintTable">
...
<script>
    ...
    $("#fullReportComplaintTable").load("fullReportComplaintTable.jsp");
