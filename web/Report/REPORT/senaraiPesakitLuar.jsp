<%-- 
    Document   : senaraiPesakitLuar
    Created on : Feb 27, 2017, 3:02:37 PM
    Author     : user
--%>
            ...
            <div class="row">      
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main" style="background: #ffffff ;">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="thumbnail">
                                <h2 style="text-align: center"> Outpatient List </h2>
                                </br>
                                ...
                                <div class="btn-group btn-group-justified" role="group" aria-label="group button">
                                    <div class="btn-group" role="group">
                                        <button type="submit" class="btn btn-success btn-block btn-lg" role="button" id="printLaporanKosPerubatan">Generate Report</button>
                                    </div>
                                    <div class="btn-group" role="group">
