...
//    patientType = "1";
    ...
    if (!startDate.equals("") && !endDate.equals("") && !hfc.equals("")) {
        ...
        query = "Select distinct adm_lookup_det.`Description`, ml.episode_date,"
                + " b.`SEX_CODE`, MONTHNAME(ml.episode_date),COUNT(*)"
                ...
                + " GROUP BY YEAR(ml.episode_date),"
                + " MONTH(ml.episode_date),"
                + " b.SEX_CODE having cast(ml.episode_date as date) BETWEEN '"+startDate+"' AND '"+endDate+"'";
