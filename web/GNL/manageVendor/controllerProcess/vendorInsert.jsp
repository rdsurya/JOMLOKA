<%-- 
    Document   : vendorInsert
    Created on : Dec 15, 2017, 8:19:37 PM
    Author     : Shammugam
--%>
...
<%
    ...
    if (duplicate.size() > 0) {
        ...
        String sqlInsert = "INSERT INTO fap_vendor (vendor_id, hfc_cd, vendor_name, vendor_bank_acc_no, vendor_bank_cd, address1, address2, address3,"
                + " towncode, poscode, district, state, country, telephone_no, fax_no, email, gl_code, roc_no, registration_date, contact_person, "
                + " payment_term, acc_type, credit_limit, currency, status, created_by, created_date )"
                + " VALUES ('" + vendor_id + "','" + hfc_cd + "','" + vendor_name + "','" + vendor_bank_acc_no + "','" + vendor_bank_cd + "','" + address1 + "',"
                ...
                + "'" + currency + "','" + status + "','" + created_by + "','" + created_date + "' )";
