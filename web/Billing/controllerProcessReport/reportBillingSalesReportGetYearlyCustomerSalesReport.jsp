<%-- 
    Document   : reportBillingSalesReportGetYearlyCustomerSalesReport
    Created on : Feb 23, 2018, 8:42:25 PM
    Author     : Shammugam
--%>
            ...
            buttons: [
                {
                    ...
                    title: 'Yearly Customer Sales List',
                    ...
                    extend: 'print',
                    text: 'Print Yearly Customer Sales List',
                    title: $('h1').text(),
                    message: '<br><br>',
                    className: 'btn btn-primary',
                    customize: function (win) {
                        $(win.document.body)
                                ...
                                .prepend(
                                        ...
                                        <img src="<%=dataLogo.get(0).get(0)%>" style="text-align: center; height: 100%; " /></div> <div class="mesej"><br>Yearly Customer Sales List for <%=year%></div>\n\
                                        <div class="info_kecik">\n\
                                        <dd>Date: <strong><%=newdate%></strong></dd>\n\
                                        <dd>Report No: <strong>BLI-0006</strong></dd>\n\
                                        </div> '
                                        );
