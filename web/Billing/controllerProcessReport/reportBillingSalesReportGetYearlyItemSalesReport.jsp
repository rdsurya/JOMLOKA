<%-- 
    Document   : reportBillingSalesReportGetYearlyItemSalesReport
    Created on : Feb 23, 2018, 11:00:20 AM
    Author     : Shammugam
--%>
        ...
        <tbody> 
            <%
                for (int i = 0; i < data.size(); i++) {
                    ...
                    int totalQty = Integer.parseInt(data.get(i).get(3));
            ...
            buttons: [
                {
                    ...
                    extend: 'print',
                    text: 'Print Yearly Item Sales List',
                    title: $('h1').text(),
                    message: '<br><br>',
                    className: 'btn btn-primary',
                    customize: function (win) {
                        $(win.document.body)
                                ...
                                .prepend(
                                        ...
                                        <img src="<%=dataLogo.get(0).get(0)%>" style="text-align: center; height: 100%; " /></div> <div class="mesej"><br>Yearly Item Sales List for <%=year%></div>\n\
                                        <div class="info_kecik">\n\
                                        <dd>Date: <strong><%=newdate%></strong></dd>\n\
                                        <dd>Report No: <strong>BLI-0009</strong></dd>\n\
                                        </div> '
                                        );
