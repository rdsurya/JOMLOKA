<%-- 
    Document   : reportBillingSalesReportGetMonthlyCustomerSalesReport
    Created on : Feb 23, 2018, 8:43:17 PM
    Author     : Shammugam
--%>
            ...
            buttons: [
                {
                    ...
                    title: 'Monthly Customer Sales List',
                    ...
                    extend: 'print',
                    text: 'Print Monthly Customer Sales List',
                    title: $('h1').text(),
                    message: '<br><br>',
                    className: 'btn btn-primary',
                    customize: function (win) {
                        $(win.document.body)
                                ...
                                .prepend(
                                        ...
                                        <img src="<%=dataLogo.get(0).get(0)%>" style="text-align: center; height: 100%; " /></div> <div class="mesej"><br>Monthly Customer Sales List for <%=monthString%> <%=year%></div>\n\
                                        <div class="info_kecik">\n\
                                        <dd>Date: <strong><%=newdate%></strong></dd>\n\
                                        <dd>Report No: <strong>BLI-0005</strong></dd>\n\
                                        </div> '
                                        );
