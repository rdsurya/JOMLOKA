<%-- 
    Document   : reportBillingSalesReportGetDailyItemSalesReport
    Created on : Feb 23, 2018, 9:38:01 AM
    Author     : Shammugam
--%>
            ...
            buttons: [
                {
                    ...
                    extend: 'print',
                    text: 'Print Daily Item Sales List',
                    title: $('h1').text(),
                    message: '<br><br>',
                    className: 'btn btn-primary',
                    customize: function (win) {
                        $(win.document.body)
                                ...
                                .prepend(
                                        ...
                                        <img src="<%=dataLogo.get(0).get(0)%>" style="text-align: center; height: 100%; " /></div> <div class="mesej"><br>Daily Item Sales List for <%=day%> <%=monthString%> <%=year%></div>\n\
                                        <div class="info_kecik">\n\
                                        <dd>Date: <strong><%=newdate%></strong></dd>\n\
                                        <dd>Report No: <strong>BLI-0007</strong></dd>\n\
                                        </div> '
                                        );
