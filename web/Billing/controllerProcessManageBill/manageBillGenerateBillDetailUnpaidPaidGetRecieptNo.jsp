<%-- 
    Document   : manageBillGenerateBillDetailUnpaidPaidGetRecieptNo
    Created on : Dec 5, 2017, 7:35:52 PM
    Author     : Shammugam
--%>
...
<%
    ...
    if (dataSeqSelect.isEmpty()) {
        ...
        String sqlSeqCreate = " INSERT INTO far_last_seq_no (hfc_cd, module_name, year_seq, status, created_by, created_date) "
                + " VALUES ('" + hfc + "','RCP','" + dateString + "','0','" + created_by + "','" + created_date + "' ) ";
    ...
    // Seq No
    String recieptNo = orderHead + orderDate;
