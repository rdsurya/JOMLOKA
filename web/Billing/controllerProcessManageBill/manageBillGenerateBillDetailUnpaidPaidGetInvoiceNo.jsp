<%-- 
    Document   : manageBillGenerateBillDetailUnpaidPaidGetInvoiceNo
    Created on : Dec 7, 2017, 8:54:19 PM
    Author     : Shammugam
--%>
...
<%
    ...
    String orderHead = "INV";
    String sqlSeqSelect = "SELECT hfc_cd,module_name,year_seq "
            + " FROM far_last_seq_no "
            + " WHERE module_name = 'INV' AND hfc_cd = '" + hfc + "' ";
    ArrayList<ArrayList<String>> dataSeqSelect = conn.getData(sqlSeqSelect);

    if (dataSeqSelect.isEmpty()) {

        //Update last sequance number
        String sqlSeqCreate = " INSERT INTO far_last_seq_no (hfc_cd, module_name, year_seq, status, created_by, created_date) "
                + " VALUES ('" + hfc + "','INV','" + dateString + "','0','" + created_by + "','" + created_date + "' ) ";
        ...
        if (dates[0] == yearString) {
            ...
            //Update last sequance number
            String sqlSeqYearUpdate = " UPDATE far_last_seq_no "
    ...
    // Seq No
    String invoiceNo = orderHead + orderDate;
